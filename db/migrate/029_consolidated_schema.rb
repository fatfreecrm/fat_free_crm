# Single migration that consolidates all the migrations (001 through 029)
# from Fat Free CRM 0.10.1. Note that the next migration file should start
# with 030.

class ConsolidatedSchema < ActiveRecord::Migration
