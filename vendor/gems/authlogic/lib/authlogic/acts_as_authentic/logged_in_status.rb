  ...
  module ActsAsAuthentic
    ...
    module LoggedInStatus
      ...
      module Methods
       ...
       #FFC named_scope :logged_in, lambda { {:conditions => ["last_request_at > ?", logged_in_timeout.seconds.ago]} }
       #FFC named_scope :logged_out, lambda { {:conditions => ["last_request_at is NULL or last_request_at <= ?", logged_in_timeout.seconds.ago]} }
