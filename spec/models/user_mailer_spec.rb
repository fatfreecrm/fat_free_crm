...
describe UserMailer do
    ...
    describe "assigned_to_account_email_notification" do
      before :each do
        ...
        @account = Factory(:account, :name => "Mastermind", :updater => @assigner, :assignee => @assignee)
    ...
    describe "assigned_to_lead_email_notification" do
      before :each do
        @assigner = Factory(:user, :first_name => "mike", :last_name => "reid", :email => "mike_reid@example.com")
        @assignee = Factory(:user, :first_name => "john", :last_name => "manne", :email => "john_manne@example.com")
        @lead = Factory(:lead, :first_name => "Master", :last_name => "Mind", :updater => @assigner, :assignee => @assignee)
    ...
    describe "assigned_to_opportunity_email_notification" do
      before :each do
        @assigner = Factory(:user, :first_name => "mike", :last_name => "reid", :email => "mike_reid@example.com")
        @assignee = Factory(:user, :first_name => "john", :last_name => "manne", :email => "john_manne@example.com")
        @opportunity = Factory(:opportunity, :name => "Mastermind", :updater => @assigner, :assignee => @assignee)
    ...
    describe "assigned_to_contact_email_notification" do
      before :each do
        @assigner = Factory(:user, :first_name => "mike", :last_name => "reid", :email => "mike_reid@example.com")
        @assignee = Factory(:user, :first_name => "john", :last_name => "manne", :email => "john_manne@example.com")
        @contact = Factory(:contact, :first_name => "Master", :last_name => "Mind", :updater => @assigner, :assignee => @assignee)
