  ...
  describe CustomField do
    it "should add a column to the database" do
      ...
      create(:custom_field,
             ...
             name: "cf_test_field",
             label: "Test Field",
             field_group: create(:field_group, klass_name: "FatFreeCrm::Contact"))
    end

    it "should generate a unique column name for a custom field" do
      field_group = build(:field_group, klass_name: "FatFreeCrm::Contact")
    ...
    describe "in case a new custom field was added by a different instance" do
      it "should refresh column info and retry on assignment error" do
        ...
        expect { FatFreeCrm::Contact.new cf_unknown_field: 123 }.to raise_error(ActiveRecord::UnknownAttributeError)
      end
