...
describe ContactsController do
  ...
  describe "responding to GET index" do
    ...
    it "should expose all contacts as @contacts" do
      Contact.should_receive(:my).with(@current_user).and_return([mock_contact])
      get :index
    ...
    describe "with mime type of xml" do
      ...
      it "should render all contacts as xml" do
        ...
        Contact.should_receive(:my).with(@current_user).and_return(contacts = mock("Array of Contacts"))
