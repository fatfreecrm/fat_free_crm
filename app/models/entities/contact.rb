...
class Contact < ActiveRecord::Base
  ...
  def self.create_for(model, account, opportunity, params)
    ...
    %w[first_name last_name title source email alt_email phone mobile blog linkedin facebook twitter zoom teams signal instagram mastodon discord bluesky do_not_call background_info].each do |name|
