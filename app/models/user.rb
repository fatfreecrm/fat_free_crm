...
class User < ActiveRecord::Base
  ...
  acts_as_authentic do |c|
    ...
    c.validates_uniqueness_of_login_field_options = { :message => I18n.t(:msg_username_taken) }
    c.validates_uniqueness_of_email_field_options = { :message => I18n.t(:msg_email_in_use) }
  ...
  validates_presence_of :username, :message => I18n.t(:msg_missing_username)
  validates_presence_of :email,    :message => I18n.t(:msg_missing_email)
