...
Additional information for developing on the Crossroads fat_free_crm fork:

* clone the repo - git clone git@github.com:crossroads/fat_free_crm.git
* initialise submodules - git submodule init
* install git hooks for submodules - rake git:install_hooks
