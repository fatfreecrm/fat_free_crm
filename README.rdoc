...
* Ruby on Rails v2.2 or later
* MySQL v4.1.1 or later (v5+ is recommended) or SQLite v3.4 or later


=== Getting The Source Code

The source code of Fat Free CRM is maintained using Git version control
system. To clone the source from the official repository use the following
command:

   $ git clone git://github.com/michaeldv/fat_free_crm.git

This will download the latest code snapshot and unpack it on your local machine.
